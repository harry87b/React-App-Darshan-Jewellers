    ...
    return (
        <ScrollView >
            <View style={styles.container}>
                <Text style={{ ...styles.heading, marginVertical:5}}>Darshan Jewellers (ਖੁਰਦ ਵਾਲੇ)</Text>
                <Text style={{  marginVertical:5}}>Since 1952</Text>
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap', marginTop: 5 }}>
                    <View style={{ margin: 10, display: 'flex', alignItems: 'center', }}>
                        <Image style={styles.img} source={{ uri: "https://firebasestorage.googleapis.com/v0/b/darshan-jewellers-a076c.appspot.com/o/Shop%20details%2FIMG_4514.jpg?alt=media&token=9e8c4ecb-7169-45ca-ad9f-33956b416cdd" }} />
                        <Text style={{ color: '#000', fontSize: 16, marginTop: 5 }}>Founder</Text>
                    </View>
                    <View style={{ margin: 10, display: 'flex', alignItems: 'center', }}>
                        <Image style={styles.img} source={{ uri: "https://firebasestorage.googleapis.com/v0/b/darshan-jewellers-a076c.appspot.com/o/Shop%20details%2F20190417204845_IMG_1297_Original_Original.jpg?alt=media&token=85be8f5f-3533-435d-be4d-011643e9b1c3" }} />
                        <Text style={{ color: '#000', fontSize: 16, marginTop: 5 }}>Owner</Text>
                    </View>
                    <View style={{ margin: 10, display: 'flex', alignItems: 'center', }}>
                        <Image style={styles.img} source={{ uri: "https://firebasestorage.googleapis.com/v0/b/darshan-jewellers-a076c.appspot.com/o/Shop%20details%2FIMG_5566_Original.jpg?alt=media&token=45d90be1-d027-469c-8730-d16a8835805d" }} />
                        <Text style={{ color: '#000', fontSize: 16, marginTop: 5 }}>Co-owner</Text>
                    </View>
                </View>

                <Text style={{textAlign:'justify',fontSize:14,padding:15,color:'#000',}}>
